...
/// <summary>
/// Clase encargada de generar el informe de línea de captura menor
/// </summary>
public partial class InformeLineaCapturaMenor : PageBaseISAI
{

    /// <summary>
    /// Load de la página InformeLineaCapturaMenor.
    /// </summary>
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                {
                    infDetalleLineasCapturaDT = ClienteDeclaracionIsai.ObtenerInfDetalleLineasCapturaMenor(decimal.Parse(lblNumNotarioDato.Text.ToString()), DateTime.Parse(lblFechaIniDato.Text.ToString()), DateTime.Parse(lblFechaFinDato.Text.ToString()));
                }
                else
                {
                    infDetalleLineasCapturaDT = ClienteDeclaracionIsai.ObtenerInfDetalleLineasCapturaMenor(null, DateTime.Parse(lblFechaIniDato.Text.ToString()), DateTime.Parse(lblFechaFinDato.Text.ToString()));
                }
