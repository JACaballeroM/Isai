...
/// <summary>
/// Clase encargada de generar el informe con todas las declaraciones de un notario concreto
/// </summary>
public partial class InformeNotariosTotales : PageBaseISAI
{
    /// <summary>
    /// Load de la página InformeNotariosTotales
    /// </summary>
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                {
                    infDetalleNotariosDT = ClienteDeclaracionIsai.ObtenerInfNotariosTotales(decimal.Parse(lblNumNotarioDato.Text.ToString()), DateTime.Parse(lblFechaIniDato.Text.ToString()), DateTime.Parse(lblFechaFinDato.Text.ToString()));
                }
                else
                {
                    infDetalleNotariosDT = ClienteDeclaracionIsai.ObtenerInfNotariosTotales(null, DateTime.Parse(lblFechaIniDato.Text.ToString()), DateTime.Parse(lblFechaFinDato.Text.ToString()));
                }
