<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterBase.master" AutoEventWireup="true" CodeFile="InformeJustificanteISR.aspx.cs" Inherits="InformeJustificanteISR" %>
    ...
    <table>
        ...
        <td style="Height:565px" valign="top">
            <rsweb:ReportViewer ID="rpvJustificanteDeclaracion" runat="server" Font-Names="Verdana"
                ...
                <LocalReport ReportPath="ReportDesign\JustificanteISR.rdlc" EnableHyperlinks="False">
                </LocalReport>
            </rsweb:ReportViewer>
      </td>
        </tr>
