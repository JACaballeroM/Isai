<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterBase.master" AutoEventWireup="true"
    CodeFile="InformeLineaCapturaTotales.aspx.cs" Inherits="InformeLineaCapturaTotales"
    Title="ISAI - Informe Lineas de captura" %>
            ...
            <td>
                <div style="float: right">
                    <rsweb:ReportViewer ID="rpvLineasCaptura" runat="server" Font-Names="Verdana" Font-Size="8pt"
                        Height="561px" Width="100%" ShowPrintButton="False">
                        <LocalReport ReportPath="ReportDesign\InfLineasCapturaTotales.rdlc">
                        </LocalReport>
                    </rsweb:ReportViewer>
                </div>
            </td>
