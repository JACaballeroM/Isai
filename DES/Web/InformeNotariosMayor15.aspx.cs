...
/// <summary>
/// Clase encargada de generar el informe sobre los notarios con las declaraciones de más 15 días en pago
/// </summary>
public partial class InformeNotariosMayor15 : PageBaseISAI
{

    /// <summary>
    /// Load de la página InformeNotariosMayor15
    /// </summary>
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                {
                    infDetalleNotariosDT = ClienteDeclaracionIsai.ObtenerInfNotariosMayor15(decimal.Parse(lblNumNotarioDato.Text.ToString()), DateTime.Parse(lblFechaIniDato.Text.ToString()), DateTime.Parse(lblFechaFinDato.Text.ToString()));
                }
                else
                {
                    infDetalleNotariosDT = ClienteDeclaracionIsai.ObtenerInfNotariosMayor15(null, DateTime.Parse(lblFechaIniDato.Text.ToString()), DateTime.Parse(lblFechaFinDato.Text.ToString()));
                }
