...
public partial class Declaracion : PageBaseISAI
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : Page_Load Inicia \n\r");

            if (!Page.IsPostBack)
            {
                System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : Page_Load SiEsPostBack \n\r");
                //add por jamg
                ...
                System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : Page_Load PreviousPage Inicia \n\r");

                if (PreviousPage == null)
                {
                    System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : PreviousPage NULL \n\r");
                    //obtenemos los datos pasados por GET ( solo se entra la primera vez que se carga la pagina )
                    System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : ObtenerDatosPorGet Inicia \n\r");
                    ObtenerDatosPorGet();

                    System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : ObtenerDatosPorGet Termina \n\r");
                    ...
                    System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : AccionesCuentaValida Inicia \n\r");
                    AccionesCuentaValida();
                    System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : AccionesCuentaValida Termina \n\r");
                }
                else
                {
                    //obtenemos los datos pasados por POST
                    System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : ObtenerDatosPorPost Inicia \n\r");
                    ObtenerDatosPorPost();
                    System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : ObtenerDatosPorPost Termina \n\r");
                ...
                System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : FechaCausacion Inicia \n\r");
                if (!DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].IsFECHACAUSACIONNull())
                {
                    System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : txtFechaCausacion " + txtFechaCausacion.Text + " \n\r");
                    FechaCausacionAnt = txtFechaCausacion.Text;
                }
                System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : FechaCausacion Termina \n\r");
                System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : IsCODACTOJURNull Inicia \n\r");
                if (!DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].IsCODACTOJURNull())
                {
                    ...
                    System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : ActoJurAnt " + ActoJurAnt + " \n\r");

                }
                System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : IsCODACTOJURNull Termina \n\r");
            }
            else
            {
        ...
        {
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : Page_Load cex : " + cex.Message + "\n\r");
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : Page_Load cex : " + cex.StackTrace + "\n\r");
        ...
        {
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : Page_Load ciex : " + ciex.Message + "\n\r");
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : Page_Load ciex : " + ciex.StackTrace + "\n\r");
        ...
        {
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : Page_Load ex : " + ex.Message + "\n\r");
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : Page_Load ex : " + ex.StackTrace + "\n\r");
    ...
    private void ObtenerDatosPorGet()
    {
        ...
        {
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : ObtenerDatosPorGet cex : " + cex.Message + "\n\r");
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : ObtenerDatosPorGet cex : " + cex.StackTrace + "\n\r");
        ...
        {
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : ObtenerDatosPorGet ciex : " + ciex.Message + "\n\r");
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : ObtenerDatosPorGet ciex : " + ciex.StackTrace + "\n\r");
        ...
        {
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : ObtenerDatosPorGet ex : " + ex.Message + "\n\r");
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : ObtenerDatosPorGet ex : " + ex.StackTrace + "\n\r");
        ...
        try
        {
            ...
            if (dse.FEXNOT_DECLARACION[0].CODTIPODECLARACION != TipoDeclaracion.JornadaNotarial.ToDecimal() && dse.FEXNOT_DECLARACION[0].CODTIPODECLARACION != TipoDeclaracion.Complementaria.ToDecimal())
                mensajeAviso = ClienteDeclaracionIsai.RegistrarDeclaracion2(
                    ...
                    valorReferido, fechaValorReferido, listaValoresIsr.ToArray(), Decimal.Parse(Usuarios.IdUsuario()));
                ...
                mensajeAviso = ClienteDeclaracionIsai.RegistrarDeclaracion2(
                    ...
                    TipoDocumentalBF,
                    ListaIdsDocumentalBF,
                    RecuperaImpuestoPagado(lblImpuestoPagadoAnterior, true), valorReferido, fechaValorReferido, listaValoresIsr.ToArray(), Decimal.Parse(Usuarios.IdUsuario()));
    ...
    private void AccionesCuentaValida()
    {
        ...
        {
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : AccionesCuentaValida cex : " + cex.Message + "\n\r");
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : AccionesCuentaValida cex : " + cex.StackTrace + "\n\r");
        ...
        {
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : AccionesCuentaValida ciex : " + ciex.Message + "\n\r");
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : AccionesCuentaValida ciex : " + ciex.StackTrace + "\n\r");
        ...
        {
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : AccionesCuentaValida ex : " + ex.Message + "\n\r");
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : AccionesCuentaValida ex : " + ex.StackTrace + "\n\r");
    ...
    protected void CrearDeclaracionDTFormulario(bool borrador)
    {
        ...
        {
            string msj = "Se presentó un error al realizar la operación: " + Environment.NewLine + Environment.NewLine + cex.Detail.Descripcion + Environment.NewLine + cex.StackTrace;
            MostrarMensajeInfoExcepcion(msj);
        }
        catch (FaultException<DeclaracionIsaiInfoException> ciex)
        {
            string msj = "Se presentó un error al realizar la operación: " + Environment.NewLine + Environment.NewLine + ciex.Detail.Descripcion + Environment.NewLine + ciex.StackTrace;
            MostrarMensajeInfoExcepcion(msj);
        }
        catch (Exception ex)
        {
            ExceptionPolicyWrapper.HandleException(ex);
            string msj = "Se presentó un error al realizar la operación: " + Environment.NewLine + Environment.NewLine + ex.Message + Environment.NewLine + ex.StackTrace;
            MostrarMensajeInfoExcepcion(msj);
        }
    }
    ...
    private void ActualizarDatosCalculo(bool cambio)
    {
        ...
        try
        {
            ...
            //JACM BaseGravable
            if (resultadoBaseGravable != null && resultadoBaseGravable != 0)
                DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].BASEGRAVABLE = (decimal)resultadoBaseGravable;
            else
                DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].BASEGRAVABLE = (decimal)0M;

            if (resultadoReduccion1995 != null && resultadoReduccion1995 != 0)
                DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].REDUCCION1995 = (decimal)resultadoReduccion1995;
            else
                DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].REDUCCION1995 = (decimal)0M;

            if (resultadoTasa1995 != null && resultadoTasa1995 != 0)
                DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].TASA1995 = (decimal)resultadoTasa1995;
            else
                DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].TASA1995 = (decimal)0M;

            if (resultadoImpuesto != null && resultadoImpuesto != 0)
                DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].IMPUESTO = (decimal)resultadoImpuesto;
            else
                DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].IMPUESTO = (decimal)0M;

            if (resultadoActualizacion != null && resultadoActualizacion != 0)
                DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].ACTUALIZACIONIMPORTE = (decimal)resultadoActualizacion;
            else
                DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].ACTUALIZACIONIMPORTE = (decimal)0M;

            if (resultadoReduccionArt309 != null && resultadoReduccionArt309 != 0)
                DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].REDUCCIONART309 = (decimal)resultadoReduccionArt309;
            else
                DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].REDUCCIONART309 = (decimal)0M;

            if (resultadoRecargo != null && resultadoRecargo != 0)
                DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].IMPORTERECARGOPAGOEXTEMP = (decimal)resultadoRecargo;
            else
                DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].IMPORTERECARGOPAGOEXTEMP = (decimal)0M;

            if (resultadoImporteCondonacion != null && resultadoImporteCondonacion != 0)
                DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].IMPORTECONDONACION = (decimal)resultadoImporteCondonacion;
            else
                DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].IMPORTECONDONACION = (decimal)0M;

            if (resultadoExencionImporte != null && resultadoExencionImporte != 0)
                DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].IMPORTEEXENCION = (decimal)resultadoExencionImporte;
            else
                DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].IMPORTEEXENCION = (decimal)0M;
    ...
    protected void txtFechaCausacion_TextChanged(object sender, EventArgs e)
    {
        ...
        if (DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].CODTIPODECLARACION != TipoDeclaracion.Anticipada.ToDecimal())
        {
            ...
            if (this.IsValid)
            {
                    ...
                    if (!string.IsNullOrEmpty(FechaCausacionAnt))
                    {
                        if (DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].CODTIPODECLARACION == TipoDeclaracion.JornadaNotarial.ToDecimal())
                        {
                            if ((!string.IsNullOrEmpty(txtRegion.Text)
                                ...
                                //Advertir que se va a actualizar el valor catastral y los beneficios fiscales
                ...
                else //si se ha metido un valor que no es vacío o fecha
                {
                    DseDeclaracionIsaiMant.FEXNOT_DECLARACION[0].SetFECHACAUSACIONNull();
                }
            }
    ...
    protected void Page_Prerender(object sender, EventArgs e)
    {
        try
        {
            ...
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : CancelControlID : Inicia \n\r");
            mpeErrorTareas.CancelControlID = errorTareas.ClientIdCancelacion;
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : CancelControlID : " + mpeErrorTareas.CancelControlID + "\n\r");
            System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : CancelControlID : Termina \n\r");
        }
        catch (Exception ex)
        {
    ...
    {
        System.IO.File.AppendAllText(AppDomain.CurrentDomain.BaseDirectory + "\\ISAI.log", "\n\r" + DateTime.Now.ToString() + " : MostrarMensajeInformacion : " + mensaje + "\n\r");
