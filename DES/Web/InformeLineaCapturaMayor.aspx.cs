...
/// <summary>
/// Clase encargada de generar el informe de línea captura mayor
/// </summary>
public partial class InformeLineaCapturaMayor : PageBaseISAI
{

    /// <summary>
    /// Load de la página InformeLineaCapturaMayor.
    /// </summary>
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!IsPostBack)
            {
                ...
                {
                    infDetalleLineasCapturaDT = ClienteDeclaracionIsai.ObtenerInfDetalleLineasCapturaMayor(decimal.Parse(lblNumNotarioDato.Text.ToString()), DateTime.Parse(lblFechaIniDato.Text.ToString()), DateTime.Parse(lblFechaFinDato.Text.ToString()));
                }
                else
                {
                    infDetalleLineasCapturaDT = ClienteDeclaracionIsai.ObtenerInfDetalleLineasCapturaMayor(null, DateTime.Parse(lblFechaIniDato.Text.ToString()), DateTime.Parse(lblFechaFinDato.Text.ToString()));
                }
